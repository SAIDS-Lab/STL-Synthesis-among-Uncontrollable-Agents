...
def Solve_Prob(k, r2_trace, r2_c):
    Robot = Model("case2")
    ...
    addConstr(Robot, x1, u1, r2_trace, k, r2_c)
    ...
    if Robot.getStatus() == "optimal":
        ...
        return state, input, comp_time
    else:
        raise Exception("Unfortunately, we did not find a solution.")
